...
CREATE TABLE `ETH_INFO` (
  `net_url` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `latest_bno` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL
...
INSERT INTO `ETH_INFO` VALUES ('http://182.252.131.50:8545','0');
